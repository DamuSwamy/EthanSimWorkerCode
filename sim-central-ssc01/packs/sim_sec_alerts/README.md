# SiM Security Alerts Pack

## Introduction 

sim_sec_alerts pack supplies actions for services related to Security Alerts from RSS Feeds for Ethan.

## Installing the pack

````
st2 pack install https://ethangroup.visualstudio.com/SPBU%20Automation/_git/sim_sec_alerts

````

## Actions and Workflows

The following actions and workflows make up the pack ("`sim_sec_alerts`"):
**NEEDS TO BE UPDATED FOR SIM SEC ALERTS PROCESSES**
````
+-------------------------------------------+------------+---------------------------+
| ref                                       | pack       | description               |
+-------------------------------------------+------------+---------------------------+
| sim_itsm.create_connectwise_ticket        | sim_vmware | Create Connectwise Ticket |
| sim_itsm.deactivate_user                  | sim_vmware | Deactivate_User           |
| sim_itsm.update_Connectwise_ticket        | sim_vmware | Update Connectwise Ticket |
+-------------------------------------------+------------+---------------------------+
