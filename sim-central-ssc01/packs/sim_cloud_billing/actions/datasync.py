...
class DataSync(Action):
    ...
    def run(self):
        ...
        username = 'svc_csp_api@system'
        password = 'v8e6-LJM4-v4t2-8o9a'
            ...
            if admin_vm_record.get('status') == 'UNKNOWN' or admin_vm_record.get('status') == 'FAILED_CREATION':
                ...
                if admin_vm_record.get('isVAppTemplate') != 'true':
                    ...
                    if vmName is not None and vmName.text:
                        ...
                        vmRecord = {}
                        vmRecord['vcID']= admin_vm_record.get('vcID')
                        ...
                        vmRecord['vmCreatedDate']= date_created.text
        ...
        while True:
            ...
            if response.status_code == 200:
                ...
                for admin_vm_record in admin_vm_records:
                    admin_vm_record.set('vcID',count)
                    count+=1
        ...
        count=1
        for output_vm in output_vms:
            output_vm['vcID']=count
            count+=1
