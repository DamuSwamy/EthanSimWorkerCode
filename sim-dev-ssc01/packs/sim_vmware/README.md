...
sim_vmware pack supplies actions for services related to VMware products used with SiM platform.

## Installing the pack

````
st2 pack install https://ethangroup.visualstudio.com/SPBU%20Automation/_git/sim_vmware

````

## Actions and Workflows

The following actions and workflows make up the pack ("`sim-vmware`"):
NEEDS TO BE UPDATED FOR VMWARE PROCESSES
````
+-------------------------------------------+------------+---------------------------+
