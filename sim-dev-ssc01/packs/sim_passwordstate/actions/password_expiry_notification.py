...
class GetUserDetailsWithinExpiryRangeAction(Action):
    def run(self):
        ...
        def send_email(to, subject, body):
            url = "https://sim-dev.sim.esecure.systems/api/v1/executions"
            headers = {
                "st2-api-key": "ODkzZjM3Y2I3OTI0ZTNiODMyODZjM2EyNmZlNzhkNThjMmQ2MWE1N2RmMjRjYzNiYTk2ZTRmMzc3NmY4ZGY5ZQ",
